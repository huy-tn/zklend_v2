...
#[starknet::interface]
pub trait IMockMarket<TContractState> {
    //
    // Getters
    //
...
#[starknet::interface]
pub trait IMockKstrkPool<TContractState> {
...
#[starknet::interface]
pub trait IMockPriceOracle<TContractState> {
    //
    // External
    //
...
#[starknet::interface]
pub trait IMockChainlinkOracle<TContractState> {
    //
    // External
    //
