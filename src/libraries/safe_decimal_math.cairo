...
pub const SCALE: felt252 = 1000000000000000000000000000;
pub const SCALE_U256: u256 = 1000000000000000000000000000;
...
pub fn mul_decimals(a: felt252, b: felt252, b_decimals: felt252) -> felt252 {
...
/// This function assumes `b` is scaled by `10 ^ b_decimals`
pub fn div_decimals(a: felt252, b: felt252, b_decimals: felt252) -> felt252 {
    // `ten_pow` already handles overflow anyways
    let scale = pow::ten_pow(b_decimals);
